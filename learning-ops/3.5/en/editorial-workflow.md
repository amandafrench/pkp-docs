...
book: learning-ops
version: 3.5
title: Learning OPS: The Editorial Workflow
---
...
See [Learning OJS 3](https://docs.pkp.sfu.ca/learning-ojs/editorial-workflow#tasks) for further information about the Submissions dashboard and tasks.
...
How an author can make a submission is explained in [Learning OJS 3](https://docs.pkp.sfu.ca/learning-ojs/authoring). It is the same in OJS and OPS except that when the author makes a submission of a new preprint, they can choose a Category to submit to instead of a Section.
...
For more information on the tabs and options available, please refer to the [Publication tabs section](/learning-ojs/production-publication#publication-tabs) of the Learning OJS guide.

For information about managing and posting metadata in multiple languages, see [Multilingual Submissions in Learning OJS 3](/learning-ojs/production-publication#multilingual-submissions).
...
For more information on versioning and editing a posted preprint, check the [Versioning of Articles](/learning-ojs/production-publication#versioning-of-articles) section of the Learning OJS guide.
